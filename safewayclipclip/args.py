...
def define_common_args(parser):
    ...
    parser.add_argument(
        ...
        default=None,
        help=(
            "Safeway username, either an e-mail or phone. If not provided, "
    ...
    parser.add_argument(
        "--safeway_password",
        default=None,
        help=("Safeway password. If not provided, " "you will be prompted for it."),
    )
    parser.add_argument(
    ...
    parser.add_argument(
        ...
        help=(
            "Directory to save browser session, including cookies. Use to "
